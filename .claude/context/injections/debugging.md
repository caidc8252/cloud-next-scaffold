...
- A debugging fix is a code change: when it touches a route/service/UI, invoke `requesting-code-review` before declaring "done" — a green `pnpm test` does not confirm conformance to the iron laws (see `AGENTS.md`).
