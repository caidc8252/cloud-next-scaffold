 ...
 *          business page: apps/admin/app/(dashboard)/system/roles/[id]/page.tsx
 *          slot page:     apps/admin/app/(dashboard)/@breadcrumbs/system/roles/[id]/page.tsx
 *
 ...
 *
 *          business page: apps/admin/app/(dashboard)/system/roles/page.tsx
 *          slot page:     apps/admin/app/(dashboard)/@breadcrumbs/system/roles/page.tsx
 *
