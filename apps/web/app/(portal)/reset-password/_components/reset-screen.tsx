...
import { resetPassword, validateResetToken } from "@/modules/identity/forgot-password/client/forgot.api";
...
import { AuthLead, ErrorBanner, IconBadge } from "@/app/(portal)/_components/card-bits";
