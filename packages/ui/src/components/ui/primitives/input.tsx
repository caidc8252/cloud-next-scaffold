...
function Input({
  ...
  const inputEl = (
    <InputPrimitive
      ...
      className={cn(
        "h-control-md w-full min-w-0 rounded-md border border-line-default bg-surface-2 px-cx-md py-1 text-md transition-colors outline-none file:inline-flex file:h-6 file:border-0 file:bg-transparent file:text-md file:font-medium file:text-foreground placeholder:text-content-tertiary focus-visible:border-line-focus focus-visible:shadow-focus read-only:bg-surface-3 read-only:text-content-secondary disabled:cursor-not-allowed disabled:bg-surface-3 disabled:opacity-50 aria-invalid:border-error-strong aria-invalid:ring-2 aria-invalid:ring-error/20 dark:bg-surface-3/30 dark:read-only:bg-surface-3/80 dark:disabled:bg-surface-3/80 dark:aria-invalid:border-error-strong/50 dark:aria-invalid:ring-error/40",
        autofillFix,
        ...
        (prefix || suffix) && "rounded-none border-0 bg-transparent focus-visible:shadow-none dark:bg-transparent aria-invalid:border-0 aria-invalid:ring-0",
        className
      )}
      {...props}
    />
  ...
  return (
    <div
      className={cn(
        "flex items-center rounded-md border border-line-default bg-surface-2 transition-colors focus-within:border-line-focus focus-within:shadow-focus dark:bg-surface-3/30",
        variant === "filled" &&
    ...
    >
      {prefix && (
        <span className="flex items-center pl-2.5 text-md text-content-tertiary select-none">
          {prefix}
        </span>
      )}
      {inputEl}
      {suffix && (
        <span className="flex items-center pr-2.5 text-md text-content-tertiary select-none">
          {suffix}
        </span>
      )}
    </div>
