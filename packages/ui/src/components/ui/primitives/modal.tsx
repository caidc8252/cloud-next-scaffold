    ...
    >
      <DialogPrimitive.Portal>
        ...
        <DialogPrimitive.Popup
          ...
          className={cn(
            "fixed top-1/2 left-1/2 z-modal flex w-full max-w-[calc(100%-2rem)] max-h-[calc(100vh-96px)] -translate-x-1/2 -translate-y-1/2 flex-col overflow-hidden rounded-2xl border border-line-subtle bg-popover text-popover-foreground shadow-1 outline-none duration-100 data-open:animate-in data-open:fade-in-0 data-open:zoom-in-95 data-closed:animate-out data-closed:fade-out-0 data-closed:zoom-out-95",
            MODAL_SIZES[size],
            className
          )}
        >
            ...
            >
              ...
              {showCloseButton && (
                <DialogPrimitive.Close
                  ...
                  className="inline-flex size-6 shrink-0 cursor-pointer items-center justify-center rounded-md text-content-tertiary transition-colors hover:bg-surface-hover hover:text-content-primary focus-visible:outline-none focus-visible:shadow-focus"
                >
                  <XIcon size={13} />
