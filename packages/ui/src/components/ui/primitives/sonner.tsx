...
const TOAST_DURATION = 1_500 // 全局默认自动消(成功 / info / warning)
const ERROR_DURATION = 3_000 // 错误更久、便于读完;仍有限、不常驻
...
const toast: typeof sonnerToast = Object.assign(
  ...
  sonnerToast,
  {
    ...
    error: (message: Parameters<typeof sonnerToast.error>[0], data?: ExternalToast) =>
      sonnerToast.error(message, withCountdown({ duration: ERROR_DURATION, ...data })),
  },
)
