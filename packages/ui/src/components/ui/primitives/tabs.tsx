  ...
  return (
    <TabsPrimitive.Tab
      ...
      className={cn(
        ...
        // reference: padding 12px 12px → fixed control height (42 snaps to scale token 44 = h-control-lg)
        "group-data-[variant=line]/tabs-list:h-control-lg group-data-[variant=line]/tabs-list:px-3 group-data-[variant=line]/tabs-list:-mb-px",
