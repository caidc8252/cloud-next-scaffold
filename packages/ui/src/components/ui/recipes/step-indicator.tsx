...
const stepDotVariants = cva(
  "flex size-8 shrink-0 items-center justify-center rounded-full border text-md transition-colors [&_svg:not([class*='size-'])]:size-3.5",
  {
    variants: {
      state: {
...
const stepLabelVariants = cva("text-md", {
  variants: {
    state: {
