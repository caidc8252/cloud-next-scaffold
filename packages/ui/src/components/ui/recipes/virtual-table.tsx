...
export function VirtualTable<R>({
  ...
  // Numeric columns right-align unless the column sets an explicit align (shared with <Table>).
        ...
        >
          {columns.map((col) => (
            <div
              ...
              className="px-4 py-3 text-xs font-medium uppercase text-content-tertiary tracking-overline"
            >
              {col.sortable ? (
                <button
